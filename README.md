...
> 一個現代化的財務管理平台，使用 **Next.js**、**React** 與 **TypeScript** 開發，整合 Serverless 資料庫、即時 UI 與完善的身份驗證。專為展示前後端開發能力與團隊協作技能而設計，適合作為面試作品。
...
> 如果有線上 demo，可放在此處
> 例如：`https://finance-platform.example.com`
...
> 此專案主要為個人作品與面試用途，但歡迎 PR 建議優化或修正錯誤。
